...
//! Project version number for OpenCloudData.
FOUNDATION_EXPORT double OpenCloudDataVersionNumber;

//! Project version string for OpenCloudData.
FOUNDATION_EXPORT const unsigned char OpenCloudDataVersionString[];
