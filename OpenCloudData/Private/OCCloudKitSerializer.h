...
- (BOOL)updateAttributes:(NSArray<NSAttributeDescription *> * _Nullable)attributes andRelationships:(NSArray<NSRelationshipDescription *> * _Nullable)relationships onManagedObject:(NSManagedObject *)managedObject fromRecord:(CKRecord *)record withRecordMetadata:(OCCKRecordMetadata *)recordMetadata importContext:(OCCloudKitImportZoneContext *)importContext error:(NSError * _Nullable *)error __attribute__((objc_direct));
@end
