...
+ (OCCKMetadataEntry * _Nullable)insertMetadataEntryWithKey:(NSString *)key stringValue:(NSString * _Nullable)stringValue forStore:(__kindof NSPersistentStore *)store intoManagedObjectContext:(NSManagedObjectContext *)managedObjectContext __attribute__((objc_direct));
+ (OCCKMetadataEntry * _Nullable)insertMetadataEntryWithKey:(NSString *)key boolValue:(BOOL)boolValue forStore:(__kindof NSPersistentStore *)store intoManagedObjectContext:(NSManagedObjectContext *)managedObjectContext __attribute__((objc_direct));
