...
+ (OCCKMirroredRelationship * _Nullable)mirroredRelationshipForManyToMany:(OCMirroredManyToManyRelationship *)manyToManyRelationship inStore:(__kindof NSPersistentStore *)store withManagedObjectContext:(NSManagedObjectContext *)managedObjectContext error:(NSError * _Nullable * _Nullable)error __attribute__((objc_direct));
+ (OCCKMirroredRelationship *)insertMirroredRelationshipForManyToMany:(OCMirroredManyToManyRelationship *)manyToManyRelationship inZoneWithMetadata:(OCCKRecordZoneMetadata *)metadata inStore:(__kindof NSPersistentStore *)store withManagedObjectContext:(NSManagedObjectContext *)managedObjectContext __attribute__((objc_direct));
