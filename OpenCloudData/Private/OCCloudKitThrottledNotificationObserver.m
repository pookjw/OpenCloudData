...
- (void)noteRecievedNotification:(NSNotification *)notification {
    ...
    if (notificationIteration != 0) {
        ...
        // x21
        __kindof _PFBackgroundRuntimeVoucher *voucher = [objc_lookUpClass("_PFClassicBackgroundRuntimeVoucher") _beginPowerAssertionNamed:self->_assertionLabel];
        ...
        dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(self->_notificationStalenessInterval * NSEC_PER_SEC)), dispatch_get_global_queue(QOS_CLASS_DEFAULT, 0), ^{
            ...
            [objc_lookUpClass("_PFClassicBackgroundRuntimeVoucher") _endPowerAssertionWithVoucher:voucher];
        });
    }
}
